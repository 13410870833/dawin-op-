...
namespace Robot
{
	...
	public:
		...
		void ResetGyroCalibration() { m_CalibrationStatus = 0; m_FBGyroCenter = 512; m_RLGyroCenter = 512; }   //重置陀螺仪数据
		int GetCalibrationStatus() { return m_CalibrationStatus; }  //得到校准状态

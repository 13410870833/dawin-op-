...
Head::Head()
{
	...
	m_BottomLimit = Kinematics::EYE_TILT_OFFSET_ANGLE - 65;//65

	m_Pan_Home = 0.0;
	m_Tilt_Home = Kinematics::EYE_TILT_OFFSET_ANGLE - 20.0;//35
...
void Head::change_bottomLimit(float angle)
{
		m_BottomLimit = angle;
}

void Head::change_TopLimit(float angle)
{
	m_TopLimit = angle;
}
void Head::change_LeftLimit(float angle)
{
	m_LeftLimit = angle;
}
void Head::change_RightLimit(float angle)
{
	m_RightLimit = angle;
}
